...
namespace Quoin.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: Quoin.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult LogOn(Quoin.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOn);
        ...
        public override System.Web.Mvc.ActionResult Register(Quoin.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ChangePassword(Quoin.Models.ChangePasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.ChangePassword);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
